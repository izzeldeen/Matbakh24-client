            ...
            <div className="col-md-12">
              <div className="row">
                ...
                <div className="col-md-6">
                  ...
                  <div className="item-content">{transaction?.user_name}</div>
                </div>
                ...
                <div className="col-md-6">
                  ...
                  <div className="item-content">{transaction?.cart_price}</div>
                </div>
                ...
                <div className="col-md-6">
                  ...
                  <div className="item-content">{transaction?.total_price}</div>
                </div>
              </div>
            </div>
          </div>
