...
export default function OrderDetail() {
  ...
  const getOrder = async () => {
    try {
      ...
      const response = await fetch(window.baseurl + "order/detail", {
        method: "post",
        headers: {
  ...
  return (
    <Tabs>
      <Link to={"/admin/orders"}>
        <i className="float-left text-danger fa-solid fa-rectangle-xmark fa-xl" />
      </Link>
      <TabList>
        ...
        <div className="col-sm-12">
          <div className="item-container">
            ...
            <div className="row">
              ...
              <div
                onClick={(e) =>
                  showMap(row?.order?.user_lat, row?.order?.user_lng)
                }
      ...
      <TabPanel>
        <div className="col-sm-12 ">
          <div className="item-container my-3">
            ...
            {carts?.map((e, index) => {
              return (
                <div className="row food-item-body">
                  <div className="col-md-6">
                    ...
                    <div className="item-title  mt-1">
                      الكمية
                      <span className="item-content mx-3">{e?.quantity}</span>
                    </div>
                  </div>
                  <div className="col-md-6">
                    <img
                      className="cart-image"
                      src={window.baseurl + "uploads/" + e?.food.photos[0]?.url}
                    />
                  </div>
                </div>
              );
