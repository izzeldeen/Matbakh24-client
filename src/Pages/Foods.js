                  ...
                  <tbody>
                    {this.paginatedList().map((e, index) => (
                      <tr>
                        ...
                        <td>
                          {e?.food.createdAt
                            ? dateFormat(e.food.createdAt, "m/d/yyyy")
                            : e?.food.createdAt}
                        </td>
                        <td>{e?.food.name.split("大")[0]}</td>
                        <td>{e?.food.marketName.split("大")[0]}</td>
                        <td>{e?.food.price - e?.food.price * 0.25 + " SR"}</td>
                        ...
                        <td>
                          ...
                          {/* <Popup
                            trigger={(open) => (
                              <button className="button btn btn-outline-success btn-sm mx-1">
                                {" "}
                                قائمة الطبخات
                              </button>
                            )}
                          ...
                          >
                            <div className="content">
                              ...
                              <CusineMeals className="container" row={e} />
                              </div>
                            </div>
                          </Popup>  */}
                        </td>
